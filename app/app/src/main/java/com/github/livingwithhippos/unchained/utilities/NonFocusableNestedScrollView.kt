 ...
 * attribute set in the layout. On Android TV this makes the scroll container itself a focus target:
 * it sits directly next to the toolbar and the navigation bar, so FocusFinder routes the d-pad onto
 * it instead of the buttons inside, and since a focused scroll view has no visual focus state the
 * screen looks like it cannot be navigated at all (see issue #376).
 *
