 ...
 * @param timeout The maximum time which espresso will wait for the view to show up (in
 *   milliseconds)
 */
fun waitForView(viewId: Int, timeout: Long): ViewAction {
    return object : ViewAction {
        ...
        override fun perform(uiController: UiController, rootView: View) {
            ...
            do {
                // Iterate through all views on the screen and see if the view we are looking for is
                // there
                // already
                ...
                // Control may not return immediately, instead it'll return after the provided delay
                // has
