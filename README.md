...
Real Debrid is a service to download files :arrow_down: from hosting websites and the torrent network. Files are downloaded directly on their servers that you can then use for your downloads. 
...
This app was is written in Kotlin and uses the following architectures/patterns/libraries:
